...
const ReviewsComponent = ({ productId }) => {
    ...
    useEffect(() => {
        if (productId) {
            axios.get(`http://localhost:5000/review/${productId}`)
                .then((response) => {
                            ...
                            <div>
                                {editingReview === review.review_id ? (
                                    <div>
                                        ...
                                        />
                                        <button onClick={() => handleUpdateReview(review.review_id)}>Update</button>
                                    </div>
                                ) : (
                ...
                <div>
                    <div>
                        {[1, 2, 3, 4, 5].map((star) => (
                            <span
                                ...
                                style={{
                                    cursor: "pointer",
                                    color: star <= (newReviews[productId]?.rating || 0) ? "#ffc107" : "#e4e5e9",
                                }}
                            >
                                ★
                            </span>
                    ...
                    <textarea
                        ...
                        onChange={(e) => setNewReviews({
                            ...newReviews,
                            [productId]: { ...newReviews[productId], review_text: e.target.value },
                        })}
                    />
